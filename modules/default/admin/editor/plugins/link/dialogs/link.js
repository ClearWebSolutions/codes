...
//										label : commonLang.url,
										...
										style: 'width:295px;top:-1px; position:relative; display:inline-block;',
										onLoad : function ()
										{
							...
							},
							{
								...
								[	
									...
									},
									{
										type : 'button',
										id : 'browse',
										className: 'cke_dialog_browseBtn',
										hidden : 'true',
										...
										[
											{
												...
												id : 'anchorName',
												'default' : '',
												label : 'Select anchor',//linkLang.anchorName,
												className: 'cke_dialog_anchorSelect',
												items :
												[
													[ '' ]
												],
						...
						[
							{
								...
								id : 'emailAddress',
								style: 'width:425px;',
								label : 'E-mail',//linkLang.emailAddress,
							...
							},
							{
								...
								id : 'emailSubject',
								style: 'width:425px;',
								label : 'Subject',//linkLang.emailSubject,
								className: 'cke_dialog_email',
								setup : function( data )
								{
									if ( data.email )
							...
							},
							{
								type : 'textarea',
								id : 'emailBody',
								label : 'Message',//linkLang.emailBody,
								rows : 3,
								'default' : '',
								className: 'cke_dialog_email',
								style: 'width:425px;',

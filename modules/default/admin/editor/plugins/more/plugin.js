...
CKEDITOR.plugins.add( 'more',
{
  ...
  init : function( editor )
  {
    ...
    editor.addCommand( 'more',
    {
      exec : function()
      {
        // There should be only one <!--more--> in document. So, look
        // for an image with class "cke_more" (the fake element).
    ...
    editor.dataProcessor.dataFilter.addRules(
      {
        comment : function( value )
        {
          ...
          if ( value == 'more' )
            return editor.createFakeParserElement( new CKEDITOR.htmlParser.comment( value ), 'cke_' + value, 'hr' );
